      ...
      <Container>
        <Box sx={styles.grid}>
          <Box as="form" sx={styles.domainCard}>
            <Heading>Fireside Protocol</Heading>
            <div style={{fontSize: '24px', marginRight: '0.5rem', fontWeight: 'bold'}}>
              <p>
              A new and secure way to create an collect digital assets leveraging tools from the best hands in the web3 industry.
              </p>
            </div>
            <br />
            <UnstoppableOnboard />
            ...
            Own a difital asset and be part of this amazing web3 revolution..
            </Text>
          </Box>
          <Box as="figure" sx={styles.illustration}>
            <Image src={"/images/cars/landing5.webp"} loading="lazy" alt="NFT" width="100%"/>
          </Box>
        </Box>
      </Container>
    </Box>
